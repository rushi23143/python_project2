...
txtDisplay = Entry(cal,font=('arisl',20,'bold'), textvariable=text_input, bd=30, insertwidth=4, bg="powder blue", justify="right").grid(columnspan=4)
...
Multiplaction=Button(cal,padx=16, bd=8, fg="black", font=('arial',20,'bold'), text="*", command=lambda:btnClick("*")).grid(row=3,column=3)
#############################################
...
btnEqual=Button(cal,padx=16,bd=8, fg="black", font=('arial',20,'bold'),text="=", command=btnEqualInput).grid(row=4,column=2)
